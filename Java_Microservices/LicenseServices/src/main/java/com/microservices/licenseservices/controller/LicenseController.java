...
public class LicenseController {
  ...
  public ResponseEntity<ResponseLicense>
  findByKey(@PathVariable("licenseKey") String licenseKey) {
  ...
  public ResponseEntity<ResponseLicense>
  partialUpdateLicenseKey(@PathVariable("licenseKey") final String licenseKey,
    ...
    for (final Field field : License.class.getDeclaredFields()) {
      ...
      final Method getter = License.class.getDeclaredMethod(
          "get" + StringUtils.capitalize(fieldName));
      final Object fieldValue = getter.invoke(license);
      if (Objects.nonNull(fieldValue)) {
        License key =
            licenseRepository.partialUpdate(licenseKey, fieldName, fieldValue);
        responseLicense.setData(key);
      }
    }
    return ResponseEntity.status(HttpStatus.OK)
  ...
  public ResponseEntity<ResponseLicense>
  delete(@PathVariable("licenseKey") String licenseKey) {
